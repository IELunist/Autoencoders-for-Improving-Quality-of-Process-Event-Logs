...
#Define parser
names = ['small_log','bpi_2012','bpi_2013','large_log']
...
for name in names:
    ...
    for count in range(10):
        ...
        def loss_function(recon_x, x, pad_index):
            MSE = F.mse_loss(recon_x*pad_index, x*pad_index, reduction='sum')
            return MSE
        ...
        score = precision_recall_fscore_support(error_activity_df.ActivityLabel.astype('float64'), predicted_time_label, average='weighted')
        ...
        print('\n')
        score_1 = precision_recall_fscore_support(error_activity_df.ActivityLabel.astype('float64'), predicted_time_label)
        print(score_1)
        ...
        print(accuracy_score(true_act_label, predicted_act_label))
